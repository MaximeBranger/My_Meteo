...
public class LandingController {
    ...
    protected void showCityList() throws IOException, InterruptedException {
        ...
        for (City city : cities) {
            ...
            link.setStyle("-fx-text-fill: white; -fx-background-color:  #0b0071; -fx-padding: 5 10 5 10; -fx-background-radius: 10px;-fx-border-insets: 5px; -fx-background-insets: 5px");
